...
var ViewController = (function () {
    ...
    ViewController.prototype.dismiss = function (data, role, navOptions) {
        ...
        var dismissPromise = Promise.resolve();
        if (this._onWillDismiss) {
            var willDismissResult_1 = this._onWillDismiss(this._dismissData, this._dismissRole);
            dismissPromise = dismissPromise.then(function () { return willDismissResult_1; });
            this._onWillDismiss = null;
        }
        return dismissPromise
            .then(function () { return _this._nav.removeView(_this, options); })
